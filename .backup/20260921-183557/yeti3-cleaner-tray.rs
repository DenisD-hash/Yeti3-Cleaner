...
fn show_about_window(controller: &Controller) {
    ...
    ABOUT_WINDOW.with(|slot| {
        ...
        let background: *mut AnyObject = unsafe {
            msg_send![
                class!(NSColor),
                colorWithCalibratedRed: 0.018f64,
                green: 0.055f64,
                blue: 0.082f64,
                alpha: 0.97f64
            ]
        ...
        unsafe {
            ...
            if !layer.is_null() {
                ...
                let border: *mut AnyObject = msg_send![
                    class!(NSColor),
                    colorWithCalibratedRed: 0.08f64,
                    green: 0.72f64,
                    blue: 1.0f64,
                    alpha: 0.38f64
                ];
        ...
        // Same approved YETI³ artwork as launcher.
        if let Some(image) = load_resource_image("Yeti3-About.png", false) {
            let art_frame = NSRect::new(NSPoint::new(22.0, 45.0), NSSize::new(510.0, 510.0));

            let image_view: Retained<NSImageView> = unsafe {
                msg_send![
                    NSImageView::alloc(mtm),
                    initWithFrame: art_frame
                ]
            };

            image_view.setImage(Some(&image));

            // The source is square 760x760 with the complete artwork
            // already fitted inside its transparent canvas.
            content.addSubview(&image_view);
        }
        ...
        about_text(
            ...
            &content,
            "YETI³ CLEANER",
            NSRect::new(NSPoint::new(555.0, 445.0), NSSize::new(310.0, 42.0)),
            28.0,
            true,
            false,
        );
        ...
        about_text(
            ...
            &content,
            "Deep macOS Cleanup",
            NSRect::new(NSPoint::new(557.0, 412.0), NSSize::new(300.0, 25.0)),
            15.0,
            false,
            true,
        );
        ...
        about_text(
            ...
            NSRect::new(NSPoint::new(557.0, 365.0), NSSize::new(300.0, 24.0)),
            12.0,
            true,
            false,
        );
        ...
        about_text(
            ...
            NSRect::new(NSPoint::new(557.0, 302.0), NSSize::new(315.0, 22.0)),
            11.0,
            true,
            true,
        );
        ...
        about_text(
            ...
            &content,
            "SWIFT / OBJC · JS",
            NSRect::new(NSPoint::new(557.0, 276.0), NSSize::new(315.0, 22.0)),
            11.0,
            true,
            true,
        );
        ...
        about_text(
            ...
            &content,
            "CODE. CLEAN. OPTIMIZE. REPEAT.",
            NSRect::new(NSPoint::new(557.0, 205.0), NSSize::new(315.0, 24.0)),
            11.0,
            true,
            false,
        );
        ...
        about_text(
            mtm,
            &content,
            "Локальная очистка · SQLite statistics",
            NSRect::new(NSPoint::new(557.0, 167.0), NSSize::new(315.0, 22.0)),
            10.5,
            false,
            true,
        );
